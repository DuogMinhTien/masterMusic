...
for (var i in Music) {
	$("#DivMusic").append (
		'<div class="cardMusic" id="Bai'+i+'" onclick="cardMusic('+i+')"><span id="play'+i+'" class="material-icons-outlined iconCard">play_circle_filled</span>'+Music[i][0]+
		'</div>'
	);
}
